-- Migration: Add works_with_milk to coffee_directory_mv and get_coffee_filter_meta
-- Description: Exposes coffees.works_with_milk in the directory MV and adds p_works_with_milk
--              to filter meta RPC so directory and counts respect the filter.

-- ============================================================================
-- 1. Recreate coffee_directory_mv with works_with_milk
-- ============================================================================
