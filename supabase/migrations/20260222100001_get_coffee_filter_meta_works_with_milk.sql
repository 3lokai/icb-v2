-- Migration: Add p_works_with_milk to get_coffee_filter_meta
-- Description: Adds p_works_with_milk parameter so filter meta counts respect works_with_milk filter.
--              Requires coffee_directory_mv to have works_with_milk column (20260222100000).
...
COMMENT ON FUNCTION public.get_coffee_filter_meta IS
  'Returns filter metadata with counts for coffee directory filtering. Uses coffee_directory_mv. Includes p_bean_species and p_works_with_milk filters.';
