-- Migration: Fix enum type casting in get_coffee_filter_meta RPC
-- Created: 2026-01-07
-- Description: Fixes type casting errors by casting TEXT[] parameters to proper enum types

-- Recreate the function with proper enum type casts
-- This fixes: "operator does not exist: roast_level_enum = text"
