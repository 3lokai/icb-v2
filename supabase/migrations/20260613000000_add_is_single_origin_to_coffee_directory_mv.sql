-- Migration: Add is_single_origin to coffee_directory_mv
-- Description: Surfaces the curated coffees.is_single_origin boolean in the directory MV
--              so the listing/filter pipeline (and the /coffees/single-origin discovery page)
--              can filter on it. Recreates the MV verbatim from
--              20260502000000_fix_normalized_250g_variant_computed_and_mv.sql with the single
--              added column and a supporting index.

-- ============================================================================
-- 1. Recreate coffee_directory_mv with is_single_origin
-- ============================================================================
...
-- ============================================================================
-- 2. Recreate refresh helper (CASCADE dropped it)
-- ============================================================================
