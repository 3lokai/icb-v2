-- Migration: Create RPC function for upserting user profiles
-- Created: 2025-12-12
-- Description: Creates a server-side function to safely upsert user profiles without ON CONFLICT issues

-- ============================================================================
-- RPC FUNCTION: upsert_user_profile
-- ============================================================================
...
COMMENT ON FUNCTION public.upsert_user_profile IS 'Safely upserts a user profile, handling both insert and update cases using transactional check-then-insert-or-update pattern';
