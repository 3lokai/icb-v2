-- ── 3. Expose on the roaster detail payload ──────────────────────────────────
-- Adds a 'similar' key. Everything else is byte-identical to
-- 20260721223837_add_editorial_fields_to_roaster_detail_rpc.sql.
