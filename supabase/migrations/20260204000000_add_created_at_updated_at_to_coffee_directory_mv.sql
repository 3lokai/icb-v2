-- Migration: Add created_at and updated_at to coffee_directory_mv
-- Description: Exposes coffees.created_at and coffees.updated_at so "newest" sort
--              uses real creation time instead of coffee_id. Requires MV recreate.
