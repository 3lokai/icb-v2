...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      ...
      format_brew_method_label: { Args: { grind_key: string }; Returns: string }
      ...
      search_directory: { Args: { lim?: number; q: string }; Returns: Json[] }
      search_gear_catalog: {
        Args: { p_category?: string; p_limit?: number; p_search_query?: string }
        Returns: {
          brand: string
          category: string
          id: string
