        ...
        <div className="mx-auto max-w-6xl">
          <div className="grid items-center gap-12 lg:grid-cols-12 lg:gap-24">
            ...
            <div className="lg:col-span-7 relative h-[500px] w-full mt-12 lg:mt-0">
              ...
              >
                <div className="relative overflow-hidden rounded-3xl border border-border/50 bg-background/80 backdrop-blur-md shadow-2xl p-6 w-[280px]">
                    ...
                    <div className="grid grid-cols-3 gap-2 w-full pt-2">
                      {[
                        ...
                        <div key={stat.label} className="text-center">
                          ...
                          <div className="text-micro uppercase">
                            {stat.label}
                          </div>
                        </div>
                      ))}
                  ...
                  {/* Canonical dot texture (was a hardcoded #000 line-grid) */}
                  <Decor texture="dots" />
                </div>
              </motion.div>
