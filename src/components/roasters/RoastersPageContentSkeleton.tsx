 ...
 * full-width grid) inside PageShell + Section. In-flow height prevents footer CLS;
 * Lottie overlay keeps the familiar loading UX. Used as Suspense fallback.
 */
export function RoastersPageContentSkeleton() {
  return (
    <>
      ...
      <LoadingOverlay text="Steeping the perfect brew..." />
    </>
  );
}
