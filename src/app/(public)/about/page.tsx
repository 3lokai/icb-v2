            ...
            <div className="relative z-10">
              ...
              <div className="grid-cards">
                {[
                  ...
                  <div
                    className="glass-card card-padding card-hover group"
                    key={item.title}
                  >
          ...
          <div className="mb-8 grid grid-cols-1 gap-8 lg:grid-cols-2">
            <div className="relative order-2 lg:order-1">
              <div className="group relative h-96 overflow-hidden rounded-xl border border-border/30">
                <div className="absolute inset-0 z-10 rounded-xl bg-gradient-to-t from-black/60 via-transparent to-black/20" />
                <Image
                ...
                <div className="absolute bottom-4 left-4 z-20 text-white">
                  <p className="rounded-full bg-black/50 px-3 py-1 font-medium text-sm backdrop-blur-sm">
              ...
              >
                <div className="flex items-start space-x-4">
                  ...
                  <div className="flex-1">
                    <h3 className="mb-3 font-bold text-primary transition-colors duration-200 group-hover:text-accent">
                      {user.title}
                    </h3>
                    <p className="text-caption leading-relaxed">
                      {user.description}
          ...
          <div className="flex flex-col items-start gap-8 lg:flex-row">
            <div className="space-y-6 lg:w-1/3">
              <div className="group relative h-64 w-full overflow-hidden rounded-xl border border-border/30">
                <div className="absolute inset-0 z-10 rounded-xl bg-gradient-to-t from-black/50 to-transparent" />
                <Image
        ...
        <section className="mb-16">
          <div className="glass-modal card-padding relative overflow-hidden rounded-3xl text-center">
            ...
            <div className="relative z-10">
              ...
              <div className="glass-card card-padding mx-auto max-w-md">
                <p className="mb-6 font-medium text-muted-foreground italic">
