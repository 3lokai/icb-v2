                ...
                <Stack gap="8">
                  ...
                  <Stack gap="6" className="text-body text-foreground">
                    <p>
                      ...
                      research-friendly resource that helps home brewers
                      discover, compare, and enjoy the rapidly growing Indian
                      specialty coffee scene.
                    </p>
                    <p>
                      In a country with over 300,000 coffee growers and a legacy
                      dating back to the 17th century, finding your perfect
                      Indian coffee shouldn&apos;t require endless scrolling
                      through social media or relying on which brands have the
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
                ...
                <div className="lg:col-span-8">
                  ...
                  >
                    ...
                    <p>
                      As a sales and marketing professional by trade, I
                      approached this project from the user&apos;s perspective.
                      What would I have wanted when I was just starting my
                      specialty coffee journey? The answer was simple: a
                      straightforward, comprehensive resource focused on Indian
                      coffee, free from marketing noise.
                    </p>
                    <div className="rounded-2xl border border-accent/20 border-l-4 border-l-accent bg-accent/5 p-8 my-4">
                      <p className="font-serif italic text-accent-foreground text-heading text-pretty">
                        &quot;A huge shoutout to r/IndianCoffee which served as
                        my primary source of information as I navigated
                        India&apos;s coffee landscape. This directory is my way
                        of giving back to that community.&quot;
                      </p>
                    </div>
