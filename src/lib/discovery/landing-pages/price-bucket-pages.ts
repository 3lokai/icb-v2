...
export const priceBucketPages: LandingPageConfig[] = [
  {
    ...
    priceBucketProfile: {
      ...
      buyingGuide: [
        ...
        },
        {
          ...
          detail:
            "All prices on ICB are normalized to 250g equivalent, so two bags of different sizes can be read against each other. Work out your per-cup cost before assuming something is cheap or expensive.",
        },
      ],
      ...
      whatToExpect: {
        ...
        roastNote:
          "Medium, medium-dark, and dark roasts split this price range almost evenly, with traditional, comfort-leaning profiles from roasters with established supply chains. Lighter roasts are comparatively rare under ₹500.",
        processNote:
          "Among coffees with a stated process, washed and natural are most common. Honey and anaerobic lots start appearing but are rarer, and when you find them under ₹500 they're worth trying.",
      },
    ...
    valueTips: [
      ...
      "Use the directory filters to match roast and brew method to your setup. There's no need to overspend to get a great cup.",
    ],
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "The roaster prices the pack they sell; ICB prices 250g of it. That's the whole difference. A 500g bag carries a higher sticker price but usually works out the same or less per 250g, which is the figure shown here.",
      },
      {
    ...
    utilityCard: {
      ...
      description:
        "Work out the coffee-to-water ratio for your budget and brewing method.",
...

  {
    ...
    priceBucketProfile: {
      whatYouGet:
        "This is the band where the label starts telling you more. Expect high-altitude single-estate lots with the variety named (SLN 795, SLN 9, Chandragiri), processing beyond washed and natural (honey, anaerobic natural, extended fermentation), and limited harvest lots that only appear seasonally. Chikmagalur and Baba Budangiri estates carry most of it, with Baarbara, Ratnagiri, and Harley the names you see most. The extra money buys processing complexity and traceability, not a bigger bag of the same thing.",
      buyingGuide: [
        {
        ...
        },
        {
          ...
          detail:
            "Two roasters might both carry a Chikmagalur natural, so compare their tasting notes side by side on ICB before buying. Community ratings and reviews give you actual buyer experience rather than marketing copy.",
        },
      ],
      whatToExpect: {
      ...
      icbDataNote:
        "The ₹500–₹1000 range is the largest and most-rated segment of the ICB catalogue, and it holds more top-rated coffees than any other price band, so community ratings are most competitive here. This is where the ICB rating data is most useful, so use it before buying.",
    },

    valueTips: [
      "Look for unique processing (natural, honey, anaerobic) and transparent farm or estate names.",
      "Limited lots often land in this band, so compare tasting notes across roasters before you commit.",
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Washed leads, natural follows. The real shift is that fermentation becomes a variable a producer advertises: honey, anaerobic, and double-fermented lots all cluster in this band, and a single estate will often list two or three of them side by side.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Airtight container, away from light, heat, and moisture. Grind just before brewing. Use within 2–3 weeks of roast date for best flavour, since premium beans are more sensitive to staleness than commodity coffee.",
      },
      {
        question: "Why does the price differ from the roaster's site?",
        answer:
          "The roaster prices the pack they sell; ICB prices 250g of it. A 500g bag has a higher sticker price and usually a lower per-250g figure, and the per-250g figure is what this page ranks on.",
      },
    ],
    utilityCard: {
      type: "calculator",
...

  {
    ...
    metaDescription:
      "Compare the best Indian specialty coffees under ₹1000, ranked by community ratings. Filter by roast, process, region and brew method, on real normalized prices.",
    ctaLabel: "Browse all coffees under ₹1000",
    intro:
      "Find the best coffee under ₹1000 in India, from Coorg and Chikmagalur daily drinkers through to high-altitude Baarbara and Ratnagiri single-estate lots. Every coffee here is community-rated and price-normalized to 250g, so you can compare like for like before you buy.",
    headerNudge:
      "₹1000 covers almost the entire Indian specialty range, where value blends and experimental microlots both live here.",
    gridNudge:
    ...
    priceBucketProfile: {
      ...
      whatToExpect: {
        ...
        processNote:
          "Washed lots lead by count, followed by natural. Anaerobic and honey lots become more common as you approach ₹1000, and these add cost and complexity, and producers price accordingly. The best washed estate lots also live near the top of this band.",
      },
      priceNormalizationNote:
        "All prices are normalized to a 250g equivalent across pack sizes, so a 100g bag at ₹300 and a 500g bag at ₹1,500 both appear as ₹600/250g. 'Under ₹1000' here means the normalized 250g price, and the total you pay on the roaster's site depends on the pack size you choose.",
      icbDataNote:
    ...
    valueTips: [
      ...
      "Check the roast date and buy 250g where you can, since it usually gives the best per-cup value in this range.",
    ],
    ...
    faqs: [
      ...
      },
      {
        question: "Why does the price differ from the roaster's site?",
        answer:
          "Because the roaster prices a pack and ICB prices 250g of it. Buy the 500g bag and you'll pay more at checkout while often paying less per 250g, which is the number this page sorts on.",
      },
    ],
    utilityCard: {
      type: "calculator",
      title: "Coffee Calculator",
      description:
        "Work out the coffee-to-water ratio for any coffee in this range.",
      href: "/tools/coffee-calculator",
      ctaText: "Try Calculator",
    },
    learnLinks: [
...

  {
    ...
    metaDescription:
      "Discover the best premium Indian coffees over ₹1000: rare varieties, experimental processing, and award-winning lots, ranked by community ratings.",
    ...
    utilityNudge:
      "Premium lots reward precision, so dial in your grind, ratio, and water temperature to do them justice.",
    ...
    priceBucketProfile: {
      ...
      whatToExpect: {
        ...
        roastNote:
          "Roasts span medium, light-medium, and light fairly evenly, since roasters tend to roast premium lots on the lighter side to protect the processing and terroir investment, though richer medium-roasted lots are equally well represented.",
        processNote:
      ...
      icbDataNote:
        "This is the most expensive tier in the ICB catalogue, and it carries the highest average community rating of any price band, so these are the coffees buyers rate most highly. Fewer coffees here have been rated yet, and reviews come from a smaller, more experienced pool, so read them closely alongside the score before committing.",
    },
    ...
    faqs: [
      {
        ...
        answer:
          "The best premium Indian coffees over ₹1000 are typically competition-grade microlots from high-altitude estates such as Ratnagiri, Baarbara, Harley, Attikan, and Kerehaklu, running varieties like SLN 9, SLN 795, Catuai, Chandragiri, and Geisha through processing that ranges from meticulous washed and natural to anaerobic and carbonic maceration. This is the highest-rated price band in the ICB catalogue, so sort by community rating to see the current top picks, all normalized to a 250g price.",
      },
      {
        question:
          "What roast and processing profiles dominate premium coffees?",
        answer:
          "Lighter than you might expect for the price. Roasters keep premium lots on the light side of medium so the fermentation work and the estate's terroir survive the roast. On process, washed and natural still lead by count, but carbonic maceration, anaerobic, and double-fermented lots are concentrated here more heavily than anywhere else in the catalogue.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Brew light and clean, with pour-over or filter, a fresh grind, and good water, to reveal the processing and terroir you paid for. Store beans airtight, away from light and heat, and use within 2–3 weeks of roast; delicate light-roasted premium lots fade fast.",
      },
      {
        question: "Why does the price differ from the roaster's site?",
        answer:
