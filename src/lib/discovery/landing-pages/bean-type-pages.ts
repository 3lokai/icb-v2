 ...
 *
 * Most pages filter on `bean_species`. The single-origin page is the exception: it filters on the `is_single_origin` boolean (see CoffeeFilters), since
...
export const beanTypePages: LandingPageConfig[] = [
  {
    ...
    gridNudge:
      "Light and light-medium roasts reveal the most variety character, so try SLN 795 lots on pour-over before reaching for milk.",
    heroBadge: "Species",
    faqOverline: "Arabica",
...

  {
    ...
    gridNudge:
      "Robusta shines in espresso and milk drinks, with dark chocolate and crema that cut through steamed milk. Try it where body matters.",
    heroBadge: "Species",
    faqOverline: "Robusta",
    ...
    beanTypeProfile: {
      ...
      commonMistakes: [
        ...
        },
        {
          ...
          fix: "Robusta's heavy body and low acidity suit pressure and immersion methods. Espresso, Moka Pot, French Press, or South Indian filter all bring out its strengths instead of exposing its flatness.",
        },
        {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Espresso at 90–92°C with a coarser grind than Arabica, Moka Pot at a medium grind, and South Indian filter with boiled water. The rule across all of them is cooler and coarser than you'd brew Arabica, which keeps the bitterness in check. Robusta is happiest with milk or under pressure, and rarely flattered by a black pour-over.",
      },
    ],
    utilityCard: {
      type: "tips",
...

  {
    ...
    beanTypeProfile: {
      ...
      commonMistakes: [
        ...
        },
        {
          ...
          fix: "Give it a French Press, an AeroPress, or a Moka Pot. A paper filter strips out the syrupy weight that is the whole reason to drink Liberica.",
        },
        {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Immersion and pressure: French Press (coarse grind, 88–92°C, 4–5 minutes), AeroPress with a metal filter, or a Moka Pot if you want it with milk. Southeast Asian drinkers take it dark-roasted with condensed milk, which is a reasonable place to start.",
      },
    ],
    utilityCard: {
      type: "tips",
...

  {
      ...
      commonMistakes: [
        {
          ...
          fix: "The two are botanical siblings, but Excelsa carries acidity that Liberica doesn't, and it takes a pour-over that Liberica can't. Don't default to immersion just because they're related.",
        },
        {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Botanically they're related, since Excelsa is a variety of Liberica, but the cup profiles are different enough that the trade treats them separately. Excelsa runs tart, fruity, and bright, with real acidity. Liberica is smokier, heavier, and more savoury. Think of them as siblings with very different personalities.",
      },
      {
        question: "Is Excelsa available in India?",
        answer:
          "Very rarely, and effectively not at commercial scale. Indian production is dominated by Arabica and Robusta, and Excelsa appears only in scattered experimental plantings. It's more available in the Philippines, Vietnam, and Malaysia, where some producers are beginning to apply specialty processing to it.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "AeroPress (90°C, inverted, 90 seconds) and French Press (92°C, 4 minutes) handle it well. Unlike Liberica, it also takes a careful V60, since the tartness responds to a clean filter. Keep temperatures a little under what you'd use for Arabica so the acidity stays fruity rather than sharp.",
      },
    ],
    utilityCard: {
      type: "tips",
...

  {
    ...
    beanTypeProfile: {
      ...
      brewGuidance: {
        recommended: ["espresso", "moka-pot", "filter-coffee", "french-press"],
        notes:
          "Blends are built for body and consistency, so they shine under pressure and with milk. Espresso: pull at 90–93°C with a fine grind and 1:2 yield ratio, starting with 18g in, 36g out in 25–30 seconds. Robusta-forward blends produce thicker crema but can run bitter, so dial slightly coarser if bitterness dominates. Moka Pot: medium-fine grind, fill the basket level, low-medium heat, which yields a strong, concentrated cup in 4–5 minutes. South Indian filter: fine grind, pack the upper chamber loosely, pour boiled water, and let it drip 10–15 minutes. French Press: coarse grind, 92°C, 4 minutes, since the metal filter preserves the full body of blends with Robusta. Higher-Arabica blends (80:20) also work on pour-over if you want a cleaner cup with some body.",
      },
      comparison: {
      ...
      commonMistakes: [
        {
          ...
          fix: "Grind coarser and pull at 90–92°C instead of 93–96°C. Robusta extracts differently, and Arabica settings on a 50:50 blend will run bitter and harsh.",
        },
        {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Espresso (90–93°C, 18g dose, 1:2 yield, 25–30 seconds), Moka Pot (medium-fine grind, low heat), and South Indian filter (fine grind, boiled water, 10–15 minute drip) suit blends best. Robusta-heavy blends give thick crema and strength; dial slightly coarser if espresso runs bitter. An 80:20 will take a pour-over too, though you give up the body that made it a blend.",
      },
    ],
    utilityCard: {
      type: "tips",
...

  {
    ...
    gridNudge:
      "Higher chicory percentages (20–30%) give a stronger, more bittersweet decoction, so start at 15% if you're new to the tradition.",
    heroBadge: "Tradition",
    faqOverline: "Chicory",
    ...
    beanTypeProfile: {
      ...
      commonMistakes: [
        {
          ...
          fix: "Chicory mixes are designed for milk. The earthy bittersweetness balances against hot milk and sugar. Black, it's overwhelming and unpleasant for most palates.",
        },
        {
          mistake: "Using a paper-filter pour-over dripper",
          fix: "Use the South Indian metal filter or a Moka Pot. Paper filters strip the body and syrupy texture that make chicory mixes special, and the metal filter preserves them.",
        },
        {
      ...
      icbDataNote:
        "Coffee–chicory mixes occupy a distinct, tradition-driven niche in the ICB catalogue, listed mainly by roasters serving the South Indian filter coffee market, among them Hunkal Estate Coffee, Gandhi's Coffee, Baarbara Coffee, and Seven Beans. They sit apart from the third-wave single-origin segment and are concentrated in the budget and mid-range price brackets. Community ratings are consistently positive from drinkers who judge them in their intended context, as a milk-based filter coffee base, not a black pour-over.",
    },
...

  {
    ...
    gridNudge:
      "Check the variety and process before brewing, since SLN 795 washed and Cauvery natural want different temperatures and grind sizes.",
    heroBadge: "Sourcing",
    ...
    beanTypeProfile: {
      ...
      roastPairing: {
        ...
        works: ["medium-roast"],
        avoid:
          "Dark roast masks the terroir, variety, and processing character that make single origins worth buying. You're paying for distinctiveness, and dark roast erases it. If you want a dark, heavy cup, a blend is better value.",
      },
      commonMistakes: [
        {
          mistake: "Using stale beans",
          fix: "Single origins are best 7–21 days post-roast. Freshness matters more here than for blends, and stale single origins lose the distinctive character that justifies the premium.",
        },
        {
    ...
    faqs: [
      {
        ...
        answer:
          "Coffee sourced from one place, whether a single estate, a specific lot within an estate, or a tightly defined region, and not blended with beans from elsewhere. This traceability lets the terroir, variety, altitude, and processing of that one source show through clearly in the cup.",
      },
      {
        question: "Single origin vs blend: what's the difference?",
        answer:
          "Single origins showcase the distinct character of one estate and change with each harvest, so they're seasonal and variable by nature. Blends combine sources for balance and year-round consistency. Neither is 'better'; they serve different goals. Single origins reward exploration; blends reward reliability.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Pour-over methods (V60, Chemex, Kalita) show terroir best. Match parameters to processing: washed lots at 93–96°C with finer grind; naturals at 90–93°C with coarser grind; honeys in between. AeroPress at 85°C inverted is versatile for any processing. Try the same origin on two different methods to understand the estate's character.",
      },
    ],
    utilityCard: {
      type: "tips",
